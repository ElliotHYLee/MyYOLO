...
class Model_CNN_0(nn.Module):
    def __init__(self, dsName='airsim'):
        ...
        seq1 = MySeqModel(input_size, [
            ...
            Conv2DBlock(128, 64, kernel=3, stride=1, padding=0, atvn='prlu', bn=True, dropout=False),
            Conv2DBlock(64, 128, kernel=1, stride=1, padding=0, atvn='prlu', bn=True, dropout=False),
            MaxPool2DBlock(128, kernel=2, stride=2, padding=0),

            Conv2DBlock(128, 256, kernel=3, stride=1, padding=0, atvn='prlu', bn=True, dropout=False),
            Conv2DBlock(256, 128, kernel=1, stride=1, padding=0, atvn='prlu', bn=True, dropout=False),
            Conv2DBlock(128, 256, kernel=3, stride=1, padding=0, atvn='prlu', bn=True, dropout=False),
            MaxPool2DBlock(256, kernel=2, stride=2, padding=0),

            Conv2DBlock(256, 512, kernel=3, stride=1, padding=0, atvn='prlu', bn=True, dropout=False),
            Conv2DBlock(512, 256, kernel=1, stride=1, padding=0, atvn='prlu', bn=True, dropout=False),
            Conv2DBlock(256, 512, kernel=3, stride=1, padding=0, atvn='prlu', bn=True, dropout=False),
            Conv2DBlock(512, 256, kernel=1, stride=1, padding=0, atvn='prlu', bn=True, dropout=False),
            Conv2DBlock(256, 512, kernel=3, stride=1, padding=0, atvn='prlu', bn=True, dropout=False),
            MaxPool2DBlock(512, kernel=2, stride=2, padding=0),

            Conv2DBlock(512, 1024, kernel=3, stride=1, padding=0, atvn='prlu', bn=True, dropout=False),
            Conv2DBlock(1024, 512, kernel=1, stride=1, padding=0, atvn='prlu', bn=True, dropout=False),
